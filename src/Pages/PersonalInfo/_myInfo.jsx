...
const _myInfo = () => {
  return (
    <ul className="w-full grid grid-cols-3 gap-x-8 gap-y-6">
      ...
      <li>
        <p className="mb-1">Отасининг исми</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
      <li>
        <p className="mb-1">Туғилган йили</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
      <li>
        <p className="mb-1">Паспорт серияси</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
      <li>
        <p className="mb-1">Ҳудуд</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
      <li>
        <p className="mb-1">Туман (шаҳар)</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
      <li>
        <p className="mb-1">Яшаш манзили</p>
        <p className="w-full max-w-[278px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg">
          AKMAL
        </p>
      </li>
