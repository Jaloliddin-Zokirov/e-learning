...
const _workActivity = () => {
  return (
    <ul className="w-full flex flex-col gap-x-8 gap-y-6">
      <li className="w-full flex items-start justify-between flex-wrap gap-x-8 gap-y-6 ">
        ...
        <div className="w-full max-w-[273px]">
          ...
          <p className="w-full max-w-[273px] overflow-x-scroll whitespace-nowrap border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg px-4 py-2.5 scrollbar-hide">
        ...
        <div className="w-full max-w-[273px]">
          ...
          <p className="w-full max-w-[273px] overflow-x-scroll whitespace-nowrap px-4 py-2.5 border border-[#bccbe8] bg-[#e8f1ff] rounded-lg text-[#596173] font-medium text-lg scrollbar-hide">
